    ...
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-r from-campori-navy to-campori-darkGreen text-white p-6 rounded-2xl shadow-lg">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold">{user.region}</h2>
            <p className="text-white/80 text-sm">Visão Geral da Região</p>
          </div>
        </div>
      </div>
  ...
  const renderClubs = () => (
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm">
        <h2 className="text-xl font-bold mb-3 text-gray-800">Clubes da {user.region}</h2>
